...
// --- 雲端配置與全域狀態 ---
const API_URL = "https://script.google.com/macros/s/AKfycbwGFNQGIAUus5rzIHyy7wxNShxdQXsjyu5rHppNjrsTI-CAEzY4zSZFy1WojUSMjjKQ/exec";
                    ...
                    fetch(API_URL, {
                        ...
                        .then(res => {
                            if (res.status === 'success') {
                                ...
                                let msg = `【系統版本 前端:v282 / 後端:${backendVer}】\n`;
